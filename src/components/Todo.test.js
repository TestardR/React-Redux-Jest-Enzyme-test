...
describe('Todo component Unit Tests', () => {
  ...
  it('should set props correctly', () => {
    component.setProps({ text: 'go running' });
    expect(component.props().children).toEqual('go running');
  });
...
describe('Todo Styling behavior', () => {
  const mockFn = jest.fn();
  it('should not have lignethroug style when Todo is incomplete', () => {
  ...
  it('should have lignethroug style when Todo is complete', () => {
    const component = shallow(
